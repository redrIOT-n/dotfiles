...
export ZSH="/home/rxored/.oh-my-zsh"
export JDTLS_HOME=/path/to/jdtls_root # Directory with the plugin and configs directories

# Optional:
export JAVA_HOME=/usr/lib/jvm/java-11-openjdk # In case you don't have java in path or want to use a version in particular
...
plugins=(git bgnotify per-directory-history vi-mode)
...
export PATH=$PATH:/home/rxored/.local/share/gem/ruby/3.0.0/bin
...
export PATH=$PATH:${HOME}/Android/Sdk/platform/
...
[ -f "/home/rxored/.ghcup/env" ] && source "/home/rxored/.ghcup/env" # ghcup-env
